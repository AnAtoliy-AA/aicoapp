...
export function LevelUpModal() {
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-[420px] rounded-3xl border border-amber-400/40 bg-[var(--background)] p-6 sm:p-8 shadow-[0_0_50px_rgba(245,158,11,0.25)] flex flex-col items-center text-center overflow-hidden">
